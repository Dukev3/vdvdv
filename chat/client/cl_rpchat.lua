...
--]]
RegisterNetEvent('esx_rpchat:nopermissions')
AddEventHandler('esx_rpchat:nopermissions', function()
ESX.ShowNotification("You Do Not Have The Facilities For This Big Man")
end)
